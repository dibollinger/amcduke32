...
void VM_DrawTileGeneric(int32_t x, int32_t y, int32_t zoom, uint16_t tilenum,
    int32_t shade, int32_t orientation, int32_t p);

void VM_DrawTile(int32_t x, int32_t y, uint16_t tilenum, int32_t shade, int32_t orientation);
static inline void VM_DrawTilePal(int32_t x, int32_t y, uint16_t tilenum, int32_t shade, int32_t orientation, int32_t p)
{
    VM_DrawTileGeneric(x, y, 65536, tilenum, shade, orientation, p);
}
static inline void VM_DrawTilePalSmall(int32_t x, int32_t y, uint16_t tilenum, int32_t shade, int32_t orientation, int32_t p)
{
