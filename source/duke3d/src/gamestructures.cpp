...
memberlabel_t const PlayerLabels[] = 
{
    ...
    MEMBER(g_player[0].ps, disable_tripbomb_code,       PLAYER_DISABLE_TRIPBOMB_CODE),
};
...
void __fastcall VM_SetPlayerInput(int const playerNum, int const labelNum, int32_t const newValue)
{
    ...
    switch (labelNum)
    {
        case INPUT_AVEL:    i.q16avel = fix16_from_int(newValue); break;
        case INPUT_HORZ:    i.q16horz = fix16_from_int(newValue); break;
