...
enum UserdefsLabel_t
{
    ...
    USERDEFS_KICK_MODE,
    USERDEFS_VOICETOGGLE,
    USERDEFS_USERQUOTE_XOFFSET,
    USERDEFS_USERQUOTE_YOFFSET,
    USERDEFS_M_CUSTOMSETTINGS,
    USERDEFS_CSARRAY,
    USERDEFS_END
};
...
*/    \
    ...
    TRANSFORM(CON_IFCFGVAR) DELIMITER \
    ...
    TRANSFORM(CON_IFPDISTGVAR) DELIMITER \
    TRANSFORM(CON_IFPDISTLVAR) DELIMITER \
    ...
    TRANSFORM(CON_PROFILENANOEND) DELIMITER \
    TRANSFORM(CON_PROFILENANOLOG) DELIMITER \
    TRANSFORM(CON_PROFILENANORESET) DELIMITER \
    TRANSFORM(CON_PROFILENANOSTART) DELIMITER \
    ...
    TRANSFORM(CON_SETMUSICVOLUME) DELIMITER \
...
#define TRANSFORM_SCRIPT_ONLY_KEYWORDS_LIST(TRANSFORM, DELIMITER) \
    ...
    TRANSFORM(CON_INCLUDEOPTIONAL) DELIMITER \
